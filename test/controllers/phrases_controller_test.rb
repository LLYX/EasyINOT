...
class PhrasesControllerTest < ActionController::TestCase
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post :create, phrase: { english_phrase: @phrase.english_phrase, french_phrase: @phrase.french_phrase }
    end
  ...
  test "should update phrase" do
    patch :update, id: @phrase, phrase: { english_phrase: @phrase.english_phrase, french_phrase: @phrase.french_phrase }
    assert_redirected_to phrase_path(assigns(:phrase))
  end
